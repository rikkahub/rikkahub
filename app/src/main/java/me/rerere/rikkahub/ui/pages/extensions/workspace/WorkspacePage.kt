...
fun WorkspacePage(vm: WorkspaceVM = koinViewModel()) {
    ...
    if (showAddDialog) {
        EditWorkspaceDialog(
            title = stringResource(R.string.workspace_new),
            initialName = "",
    ...
    RikkaConfirmDialog(
        ...
        title = stringResource(R.string.workspace_delete),
        confirmText = stringResource(R.string.workspace_delete_action),
        dismissText = stringResource(R.string.workspace_cancel),
        onConfirm = {
        ...
        Text(stringResource(R.string.workspace_delete_confirm))
    }
}
...
private fun EmptyWorkspaceState() {
    Column(
        ...
        Text(
            text = stringResource(R.string.workspace_empty_desc),
                ...
                Box {
                    ...
                    DropdownMenu(
                        ...
                        DropdownMenuItem(
                            text = {
                                Text(
                                    text = stringResource(R.string.workspace_delete_action),
