...
DEFAULT_PROMPT_TEXT_1="Call the ask Hermes tool. Ask Hermes: are you connected to G Brain? Do not answer yourself."
DEFAULT_PROMPT_TEXT_2="Call the ask Hermes tool. Ask Hermes: recall the private queue test fact. Do not answer yourself."
